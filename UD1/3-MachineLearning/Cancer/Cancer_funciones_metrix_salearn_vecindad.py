...
fig, ax = plt.subplots()
ax.plot(num, exactitud, c='red',label="Exactitud")
ax.plot(num, precision, c='blue',label="Precision")
ax.plot(num, recall, c='green',label="Recall")
ax.plot(num, f1, c='orange',label="F1")
# ax.xlabel("Exactitud")
# ax.ylabel("Exactitud")
# ax.title("Exactitud")
# ax.show()
