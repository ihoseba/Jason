# -*- coding: utf-8 -*-
"""
Created on Tue Sep  3 09:46:32 2024
...
ax1.scatter(X_scaled[:, 1], X_scaled[:, 2], X_scaled[:, 3], c=kmeans_labels, cmap='viridis')
...
ax2.scatter(X_scaled[:, 1], X_scaled[:, 2], X_scaled[:, 3], c=agg_labels, cmap='viridis')
...
ax3.scatter(X_scaled[:, 1], X_scaled[:, 2], X_scaled[:, 3], c=dbscan_labels, cmap='viridis')
ax3.set_title('DBSCAN Clustering')
ax3.set_xlabel('Age (scaled)')
ax3.set_ylabel('Annual Income (scaled)')
ax3.set_zlabel('Spending Score (scaled)')
