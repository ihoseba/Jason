"""
Prediccion solo numerica, no grafica
"""
import pandas as pd
import numpy as np
...
X_prescaled = data.iloc[:, :30]  # Usamos todas las columnas como características
y = data['Class']

#Escalar
scaler = StandardScaler()
X_array = scaler.fit_transform(X_prescaled)
X=pd.DataFrame(X_array,columns=["Colmn1","Colmn2","Colmn3","Colmn4","Colmn5",
                                "Colmn6","Colmn7","Colmn8","Colmn9","Colmn10",
                                "Colmn11","Colmn12","Colmn13","Colmn14","Colmn15",
                                "Colmn16","Colmn17","Colmn18","Colmn19","Colmn20",
                                "Colmn21","Colmn22","Colmn23","Colmn24","Colmn25",
                                "Colmn26","Colmn27","Colmn28","Colmn29","Colmn30"
                                ])
