...
#Cargamos en X la longitud y anchura del pétalo, tal y como hemos hecho en
...
arbol_clf=DecisionTreeClassifier(criterion="gini")
arbol_clf.fit(X,y)

export_graphviz(arbol_clf,out_file="arbol_iris.dot",
