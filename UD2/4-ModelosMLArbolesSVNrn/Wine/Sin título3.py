# -*- coding: utf-8 -*-
"""
Created on Tue Jul 16 14:02:35 2024
...
plt.title(f"SVM (kernel lineal)\nPrecisión: {accuracy_svm_linear:.2f}")
plt.xlabel("Alcohol")
plt.ylabel("Proline")
...
plt.subplot(1, 2, 2)
plt.scatter(X_test[:, 0], X_test[:, 12], c=y_test, cmap='viridis', edgecolor='k')
plt.title(f"SVM (kernel RBF)\nPrecisión: {accuracy_svm_rbf:.2f}")
plt.xlabel("Alcohol")
plt.ylabel("Proline")
plt.legend(["Clase 0", "Clase 1", "Clase 2"])
