...
arbol_reg1=DecisionTreeRegressor(criterion="squared_error")
x_re1=x.reshape(-1,1)
...
# Abre la imagen
img1 = Image.open("arbol_regresion1.png")
...
# del tamaño de la muestra de puntos.
n=int(0.2 * len(x))
arbol_reg2=DecisionTreeRegressor(criterion="squared_error",max_leaf_nodes=n)
x_re2=x.reshape(-1,1)
...
# Abre la imagen
img2 = Image.open("arbol_regresion2.png")
# Muestra la imagen en una ventana
img2.show()
